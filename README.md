# GABO'S - Gestión de citas

Repositorio del trabajo académico de Interacción Humano-Computador orientado al análisis y diseño de una propuesta para mejorar la gestión de citas de un centro de fisioterapia.

## Objetivo

Analizar el proceso actual de agendamiento, identificar las necesidades de sus usuarios y proponer un mecanismo híbrido que combine la automatización de las solicitudes habituales con la revisión del personal en los casos que requieren criterio humano.

## Contenido del repositorio

La documentación se encuentra en la carpeta [`informe/`](./informe/):

| Archivo | Contenido |
|---|---|
| [`01-flujo-as-is.md`](./informe/01-flujo-as-is.md) | Análisis del proceso actual de agendamiento. |
| [`02-usuarios-necesidades.md`](./informe/02-usuarios-necesidades.md) | Usuarios involucrados y necesidades identificadas. |
| [`03-comparacion-mecanismos.md`](./informe/03-comparacion-mecanismos.md) | Comparación y selección del mecanismo de agendamiento. |
| [`04-indicadores-eficiencia.md`](./informe/04-indicadores-eficiencia.md) | Definición de indicadores para evaluar la eficiencia. |
| [`05-metaforas-interfaz.md`](./informe/05-metaforas-interfaz.md) | Metáforas, affordances, estados y criterios de usabilidad. |
| [`06-prototipo.md`](./informe/06-prototipo.md) | Descripción del prototipo navegable y de sus pantallas. |
| [`07-validacion.md`](./informe/07-validacion.md) | Protocolo y registro de la validación con usuarios. |
| [`08-recomendacion.md`](./informe/08-recomendacion.md) | Recomendación final y justificación del mecanismo híbrido. |

## Prototipo navegable

[Abrir el prototipo de GABO'S en Figma](https://www.figma.com/design/5Wb9weDs7bpY1WdUnVrif9/GABO-S---Prototipo-Gesti%C3%B3n-de-Citas?node-id=0-1&t=CZsZQNrpiL6RdLAU-1)

El prototipo representa el flujo de consulta de disponibilidad, registro, confirmación, revisión, modificación y cancelación de citas, incluidos los estados de éxito y error.
